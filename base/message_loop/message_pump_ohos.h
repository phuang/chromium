...
// MessagePumpType::JAVA MessageLoops on OS_OHOS platform.
//
...
class BASE_EXPORT MessagePumpOHOS : public MessagePump {
 public:
  MessagePumpOHOS();
  ...
  static void SetNapiEnv(napi_env env);
  ...
  void OnDelayedLoopCallback();
  virtual void OnNonDelayedLoopCallback();  // Overridden for testing.
 ...
 protected:
  ...
  virtual void DoDelayedLoopWork();
  virtual void DoNonDelayedLoopWork(bool do_idle_work);
 ...
 private:
  ...
  uv_poll_t non_delayed_poll_;
  uv_poll_t delayed_poll_;
