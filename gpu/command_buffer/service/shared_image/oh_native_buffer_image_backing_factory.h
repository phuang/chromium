...
#ifndef GPU_COMMAND_BUFFER_SERVICE_SHARED_IMAGE_OH_NATIVE_BUFFER_IMAGE_BACKING_FACTORY_H_
...
class GPU_GLES2_EXPORT OHNativeBufferImageBackingFactory
    : public SharedImageBackingFactory {
 public:
  explicit OHNativeBufferImageBackingFactory(
      const gles2::FeatureInfo* feature_info,
      const GpuPreferences& gpu_preferences);

  OHNativeBufferImageBackingFactory(const OHNativeBufferImageBackingFactory&) =
      delete;
  OHNativeBufferImageBackingFactory& operator=(
      const OHNativeBufferImageBackingFactory&) = delete;

  ~OHNativeBufferImageBackingFactory() override;
...
#endif  // GPU_COMMAND_BUFFER_SERVICE_SHARED_IMAGE_OH_NATIVE_BUFFER_IMAGE_BACKING_FACTORY_H_
