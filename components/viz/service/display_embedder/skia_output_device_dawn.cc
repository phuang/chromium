...
bool SkiaOutputDeviceDawn::Initialize(gpu::SurfaceHandle surface_handle) {
  ...
  wgpu::SurfaceSourceOHNativeWindow oh_native_window_desc;
  oh_native_window_desc.window = oh_native_window_.native_window();
  surface_desc.nextInChain = &oh_native_window_desc;
#endif
