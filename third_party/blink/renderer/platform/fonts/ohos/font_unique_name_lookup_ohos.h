...
#ifndef THIRD_PARTY_BLINK_RENDERER_PLATFORM_FONTS_OHOS_FONT_UNIQUE_NAME_LOOKUP_OHOS_H_
#define THIRD_PARTY_BLINK_RENDERER_PLATFORM_FONTS_OHOS_FONT_UNIQUE_NAME_LOOKUP_OHOS_H_
...
class FontUniqueNameLookupOHOS : public FontUniqueNameLookup {
 public:
  ...
  FontUniqueNameLookupOHOS& operator=(const FontUniqueNameLookupOHOS&) =
      delete;
...
#endif  // THIRD_PARTY_BLINK_RENDERER_PLATFORM_FONTS_OHOS_FONT_UNIQUE_NAME_LOOKUP_OHOS_H_
